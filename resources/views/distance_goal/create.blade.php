        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('distance_goal.store') }}" method="POST" class="space-y-4 max-w-md">
                        @csrf
                        <div class="space-y-1">
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="number" id="distance_to_do" name="distance_to_do" required class="mt-1 h-8 w-64 pl-2 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
                        </div>

                        <div class="space-y-1">
                            <label for="begin_date" class="block text-sm font-medium text-gray-700">Date de début</label>
                            <input type="date" id="begin_date" name="begin_date" required class="mt-1 h-8 w-64 pl-2 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm"
                                   pattern="\d{2}/\d{2}/\d{4}" placeholder="jj/mm/aaaa">
                        </div>

                        <div class="space-y-1">
                            <label for="end_date" class="block text-sm font-medium text-gray-700">Date de fin</label>
                            <input type="date" id="end_date" name="end_date" required class="mt-1 h-8 w-64 pl-2 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm"
                                   pattern="\d{2}/\d{2}/\d{4}" placeholder="jj/mm/aaaa">
                        </div>
                        ...
                        <input type="number" id="distance_done" name="distance_done" value=0 hidden>
